...
local DEFAULT_HYPER_LOGO_URL = "https://raw.githubusercontent.com/projectsingularityv1-debug/HYPER-LOADER/main/HYPER.png"
...
local function resolveLogo(url)
    ...
    if isHyper then
        ...
        local remoteUrls = {
            "https://raw.githubusercontent.com/projectsingularityv1-debug/HYPER-LOADER/main/HYPER.png",
...
local Config = {
    ...
    LogoAsset = "https://raw.githubusercontent.com/projectsingularityv1-debug/HYPER-LOADER/main/HYPER.png",
    FallbackLogo = "https://raw.githubusercontent.com/projectsingularityv1-debug/HYPER-LOADER/main/HYPER.png",
    LogoSize = 300, -- à¸‚à¸™à¸²à¸” Logo à¸„à¸¡à¸Šà¸±à¸” à¸ªà¸§à¸¢à¸‡à¸²à¸¡ à¹„à¸¡à¹ˆà¸¡à¸µà¸‚à¸­à¸šà¸‚à¸²à¸§
...
local function runLoaderSequence(gameName, gameConfig)
    ...
    if not gameName or not gameConfig then
        -- Game Not Supported Flow
        updateProgress(0.4, 0.5, "[File] Reading Games.lua...", "Searching for PlaceId: " .. tostring(PlaceId))
        task.wait(0.8)

        updateProgress(1.0, 0.5, "Game Not Supported!", "PlaceId " .. tostring(PlaceId) .. " is not registered in Games.lua", true)
        task.wait(3.0)
